...
export const IconBank = () => (
  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 10h18M7 15h1m4 0h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>
);
...
export const IconRocket = () => (
  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.585 15.585a6.267 6.267 0 001.415-4.17V5.5l-3.5 3.5m-2-2L8 10.5v5.915a6.267 6.267 0 001.415 4.17M12 12v.01M12 15v.01M12 18v.01" /></svg>
);
...
export const BadgeSymbol = ({ color = 'emerald' }) => (
  <div className={`relative w-14 h-14 flex items-center justify-center group`}>
    <svg className={`absolute inset-0 w-full h-full text-${color}-500 opacity-20 group-hover:opacity-40 transition-opacity`} viewBox="0 0 100 100">
      <path d="M50 5 L90 25 L90 75 L50 95 L10 75 L10 25 Z" fill="currentColor" />
    </svg>
    <svg className={`absolute inset-0 w-full h-full text-${color}-500`} viewBox="0 0 100 100" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M50 5 L90 25 L90 75 L50 95 L10 75 L10 25 Z" strokeDasharray="5,5" />
      <circle cx="50" cy="50" r="30" strokeOpacity="0.5" />
    </svg>
    <svg className={`relative w-6 h-6 text-${color}-500 filter drop-shadow-[0_0_8px_rgba(16,185,129,0.5)]`} fill="currentColor" viewBox="0 0 20 20">
